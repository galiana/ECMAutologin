...
namespace Galiana.Helpers
{
    public static class ConstantsHelper
    {
        ...
        {
            public const string VerifyUserAgainstEmail = "{2C42A719-D105-4AA8-8A9F-C59108268EB5}";
            public const string PersistentLogin = "{1F089B6A-401B-4648-AA6F-F32BD9AE56DD}";
